    ...
    public static class Configuration {
        ...
        public static class Values {
            ...
            public String[] cooldown = {
                    ...
                    "(50+){17 * 20 + 6 * 20 * (1- (((e^(0.1 * ((x-49) / (y-49))) - 1)/((e^0.1) - 1))))}",
                    "(100){16 * 20}"
            };

            @Config.Comment("Duration Function f(x,y)=? where 'x' is [Current Level] and 'y' is [Max Level]")
            public String[] time = {
                    "(0+){8 * 20 + 2.5 * 20 * (1 - (e^(-2.1 * (x/49)))) / (1 - e^(-2.1))}",
                    "(50+){10.5 * 20 + 1.5 * 20 * ((e^(0.1 * ((x - 49) / (y - 49))) - 1)/((e^0.1) - 1))}",
                    "(100){12 * 20}"
            };

            @Config.Comment("Range Function f(x,y)=? where 'x' is [Current Level] and 'y' is [Max Level]")
            public String[] range = {
                    "(0+){10 + 7 * (1 - (e^(-2.1 * (x/49)))) / (1 - e^(-2.1))}",
                    "(50+){17 + 3 * ((e^(0.1 * ((x - 49) / (y - 49))) - 1)/((e^0.1) - 1))}"
            };
            ...
            public static class Extra {
                ...
                public String[] launch = {
                        "(0+){2 + 12 * (1 - (e^(-2.1 * (x/49)))) / (1 - e^(-2.1))}",
                        "(50+){14 + 6 * ((e^(0.1 * ((x - 49) / (y - 49))) - 1)/((e^0.1) - 1))}"
                };
            }
