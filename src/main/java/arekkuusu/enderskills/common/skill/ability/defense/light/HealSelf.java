    ...
    public void use(EntityLivingBase owner, SkillInfo skillInfo) {
        ...
        if (isActionable(owner) && canActivate(owner)) {
            ...
            if (owner.world instanceof WorldServer) {
                ((WorldServer) owner.world).playSound(null, owner.posX, owner.posY, owner.posZ, ModSounds.HEAL_SELF, SoundCategory.PLAYERS, 5.0F, (1.0F + (owner.world.rand.nextFloat() - owner.world.rand.nextFloat()) * 0.2F) * 0.7F);
            }
        }
    }
    ...
    public static class Configuration {
        ...
        public static class Values {
            ...
            public String[] cooldown = {
                    "(0+){50 * 20 + 10 * 20 * (1 - ((1 - (e^(-2.1 * (x/24)))) / (1 - e^(-2.1))))}",
                    "(25+){47 * 20 + 3 * 20 * (1- (((e^(0.1 * ((x-24) / (y-24))) - 1)/((e^0.1) - 1))))}",
                    "(50){(45 * 20)}"
            };
