...
public class BlackFlameBall extends BaseAbility implements IImpact, IScanEntities, IExpand, IFindEntity {

    public BlackFlameBall() {
        super(LibNames.BLACK_FLAME_BALL, new Properties());
    }
    ...
    /*Config Section*/
    public static final String CONFIG_FILE = LibNames.BLACK_FLAME_OFFENCE_CONFIG + LibNames.BLACK_FLAME_BALL;
