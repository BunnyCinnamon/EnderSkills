            ...
            if (c.isOwned(this)) {
                if (!GuiScreen.isShiftKeyDown()) {
                    ...
                    c.getOwned(this).ifPresent(skillInfo -> {
                        ...
                        description.add(TextHelper.translate("desc.gas_duration", TextHelper.format2FloatPoint(getCloudDuration(abilityInfo) / 20D), TextHelper.getTextComponent("desc.stats.suffix_time")));
                        description.add(TextHelper.translate("desc.gas_range", TextHelper.format2FloatPoint(getCloudRange(abilityInfo)), TextHelper.getTextComponent("desc.stats.suffix_blocks")));
                        ...
                        if (abilityInfo.getLevel() < getMaxLevel()) { //Copy info and set a higher level...
                            ...
                            description.add(TextHelper.translate("desc.gas_duration", TextHelper.format2FloatPoint(getCloudDuration(infoNew) / 20D), TextHelper.getTextComponent("desc.stats.suffix_time")));
                            description.add(TextHelper.translate("desc.gas_range", TextHelper.format2FloatPoint(getCloudRange(infoNew)), TextHelper.getTextComponent("desc.stats.suffix_blocks")));
