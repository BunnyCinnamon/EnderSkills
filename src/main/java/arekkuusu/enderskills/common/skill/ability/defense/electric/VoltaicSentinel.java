...
import arekkuusu.enderskills.common.skill.ability.defense.earth.AnimatedStoneGolem;
...
public class VoltaicSentinel extends BaseAbility {
    ...
    public int getTime(AbilityInfo info) {
        int level = getLevel(info);
        int levelMax = getMaxLevel();
        double func = ExpressionHelper.getExpression(this, AnimatedStoneGolem.Configuration.getSyncValues().time, level, levelMax);
    ...
    @Config(modid = LibMod.MOD_ID, name = LibMod.MOD_ID + "/Ability/" + LibNames.VOLTAIC_SENTINEL)
    public static class Configuration {

        @Config.Comment("Ability Values")
        @Config.LangKey(LibMod.MOD_ID + ".config." + LibNames.VOLTAIC_SENTINEL)
        ...
        public static class Values {
            ...
            public static class Extra {
                @Config.Comment("Sentinel Damage Function f(x,y)=? where 'x' is [Current Level] and 'y' is [Max Level]")
