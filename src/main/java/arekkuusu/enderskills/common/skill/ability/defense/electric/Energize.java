...
public class Energize extends BaseAbility implements IImpact {
    ...
    public Energize() {
        super(LibNames.ENERGIZE, new AbilityProperties());
            ...
            if (c.isOwned(this)) {
                if (!GuiScreen.isShiftKeyDown()) {
                    ...
                    c.getOwned(this).ifPresent(skillInfo -> {
                        ...
                        description.add(TextHelper.translate("desc.stats.restore", TextHelper.format2FloatPoint(getPower(abilityInfo)), TextHelper.getTextComponent("desc.stats.suffix_percentage")));
                        if (abilityInfo.getLevel() < getMaxLevel()) { //Copy info and set a higher level...
                            ...
                            description.add(TextHelper.translate("desc.stats.restore", TextHelper.format2FloatPoint(getPower(infoNew)), TextHelper.getTextComponent("desc.stats.suffix_percentage")));
                        }
                    });
                }
            }
    ...
    @Config(modid = LibMod.MOD_ID, name = LibMod.MOD_ID + "/Ability/" + LibNames.ENERGIZE)
    public static class Configuration {

        @Config.Comment("Ability Values")
        @Config.LangKey(LibMod.MOD_ID + ".config." + LibNames.ENERGIZE)
        ...
        public static class Values {
            ...
            public static class Extra {
                @Config.Comment("Power restore Function f(x,y)=? where 'x' is [Current Level] and 'y' is [Max Level]")
                public String[] power = {
