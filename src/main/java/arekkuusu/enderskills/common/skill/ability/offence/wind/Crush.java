            ...
            if (c.isOwned(this)) {
                if (!GuiScreen.isShiftKeyDown()) {
                    ...
                    c.getOwned(this).ifPresent(skillInfo -> {
                        ...
                        description.add(TextHelper.translate("desc.stats.crush_range", TextHelper.format2FloatPoint(getSize(abilityInfo)), TextHelper.getTextComponent("desc.stats.suffix_blocks")));
                        ...
                        if (abilityInfo.getLevel() < getMaxLevel()) {
                            if (!GuiScreen.isCtrlKeyDown()) {
                                ...
                                description.add(TextHelper.translate("desc.stats.crush_range", TextHelper.format2FloatPoint(getSize(infoNew)), TextHelper.getTextComponent("desc.stats.suffix_blocks")));
