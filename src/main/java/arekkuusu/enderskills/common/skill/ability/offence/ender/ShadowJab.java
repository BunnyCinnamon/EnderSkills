...
public class ShadowJab extends BaseAbility implements ISkillAdvancement {
    ...
    public ShadowJab() {
        super(LibNames.SHADOW_JAB, new AbilityProperties());
    ...
    public static class Configuration {
        ...
        public static class Values {
            ...
            public String[] cooldown = {
                    "(0+){17 * 20 + 11 * 20 * (1 - ((1 - (e^(-2.1 * (x/24)))) / (1 - e^(-2.1))))}",
                    "(25+){12 * 20 + 5 * 20 * (1- (((e^(0.1 * ((x-24) / (y-24))) - 1)/((e^0.1) - 1))))}",
                    "(50){(8 * 20)}"
            };
            ...
            public static class Extra {
                ...
                public String[] dot = {
                        ...
                        "(25+){7.18 + ((e^(2.25 * ((x-24) / (y-24))) - 1)/((e^2.25) - 1)) * (21 - 7.18)}",
                        "(50){22}"
                };
