...
public class Suffocate extends BaseAbility implements IImpact, ILoopSound, IScanEntities, IExpand, ISkillAdvancement {
    ...
    public Suffocate() {
        super(LibNames.SUFFOCATE);
        setTexture(ResourceLibrary.SUFFOCATE);
    }
    ...
    public void writeSyncConfig(NBTTagCompound compound) {
        ...
        compound.setString("extra.suffocateRange", Configuration.getValues().extra.suffocateRange);
        compound.setString("extra.suffocateDoT", Configuration.getValues().extra.suffocateDoT);
    ...
    public void readSyncConfig(NBTTagCompound compound) {
        ...
        Configuration.getSyncValues().extra.suffocateRange = compound.getString("extra.suffocateRange");
        Configuration.getSyncValues().extra.suffocateDoT = compound.getString("extra.suffocateDoT");
    ...
    public static class Configuration {
        ...
        public static class Values {
            ...
            public String cooldown = "(80 * 20) + (20 * 20) * (1 - ((e^(-0.1 * (x / y)) - 1)/((e^-0.1) - 1)))";

            @Config.Comment("Duration Function f(x,y)=? where 'x' is [Current Level] and 'y' is [Max Level]")
            public String time = "(10 * 20) + ((e^(-0.1 * (x / y)) - 1)/((e^-0.1) - 1)) * ((18 * 20) - (10 * 20))";
            ...
            public static class Extra {
                ...
                public String suffocateRange = "8 + ((e^(-0.1 * (x / y)) - 1)/((e^-0.1) - 1)) * (24 - 8)";
                @Config.Comment("Damage Over Time Range Function f(x,y)=? where 'x' is [Current Level] and 'y' is [Max Level]")
                public String suffocateDoT = "9 + ((e^(-0.1 * (x / y)) - 1)/((e^-0.1) - 1)) * (13 - 9)";
            }
