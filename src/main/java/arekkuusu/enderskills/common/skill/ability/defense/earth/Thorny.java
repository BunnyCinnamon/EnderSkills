...
public class Thorny extends BaseAbility implements ISkillAdvancement {

    public Thorny() {
        super(LibNames.THORNY, new AbilityProperties());
        ...
        Capabilities.get(entity).ifPresent(capability -> {
            if (capability.isOwned(this) && capability.isActive(this)) {
                capability.getOwned(this).ifPresent(skillInfo -> {
                    ...
                    double damage = originalDamage + (originalDamage * getDamage(abilityInfo));
            ...
            if (c.isOwned(this)) {
                if (!GuiScreen.isShiftKeyDown()) {
                    ...
                    c.getOwned(this).ifPresent(skillInfo -> {
                        ...
                        description.add(TextHelper.translate("desc.stats.thorns_damage", TextHelper.format2FloatPoint(getDamage(abilityInfo) * 100) + "  %"));
                        if (abilityInfo.getLevel() < getMaxLevel()) { //Copy info and set a higher level...
                            ...
                            description.add(TextHelper.translate("desc.stats.thorns_damage", TextHelper.format2FloatPoint(getDamage(infoNew) * 100) + "  %"));
                        }
                    });
                }
            }
    ...
    @Config(modid = LibMod.MOD_ID, name = LibMod.MOD_ID + "/Ability/" + LibNames.THORNY)
    public static class Configuration {

        @Config.Comment("Ability Values")
        @Config.LangKey(LibMod.MOD_ID + ".config." + LibNames.THORNY)
        ...
        public static class Values {
            ...
            public String[] time = {
                    ...
                    "(25+){11 * 20 + 3 * 20 * ((e^(0.1 * ((x - 24) / (y - 24))) - 1)/((e^0.1) - 1))}",
                    "(50){16 * 20}"
            };
