...
public class Push extends BaseAbility implements IImpact, IScanEntities, IExpand, IFindEntity, ISkillAdvancement {
    ...
    public Push() {
        super(LibNames.PUSH);
        setTexture(ResourceLibrary.PUSH);
    ...
    public void writeSyncConfig(NBTTagCompound compound) {
        ...
        compound.setString("extra.pushRange", Configuration.getValues().extra.pushRange);
        compound.setString("extra.push", Configuration.getValues().extra.push);
    ...
    public void readSyncConfig(NBTTagCompound compound) {
        ...
        Configuration.getSyncValues().extra.pushRange = compound.getString("extra.pushRange");
        Configuration.getSyncValues().extra.push = compound.getString("extra.push");
    ...
    public static class Configuration {
        ...
        public static class Values {
            ...
            public String cooldown = "(8 * 20) + (6 * 20) * (1 - ((e^(-0.1 * (x / y)) - 1)/((e^-0.1) - 1)))";

            @Config.Comment("Duration Function f(x,y)=? where 'x' is [Current Level] and 'y' is [Max Level]")
            public String time = "3 * 20 + ((e^(-0.1 * (x / y)) - 1)/((e^-0.1) - 1)) * (8 * 20 - 3 * 20)";
            ...
            public static class Extra {
                ...
                public String pushRange = "4 + ((e^(-0.1 * (x / y)) - 1)/((e^-0.1) - 1)) * (8 - 4)";
                @Config.Comment("Push Force Function f(x,y)=? where 'x' is [Current Level] and 'y' is [Max Level]")
                public String push = "6 + ((e^(0.1 * (x / y)) - 1)/((e^0.1) - 1)) * (40 - 6)";
            }
