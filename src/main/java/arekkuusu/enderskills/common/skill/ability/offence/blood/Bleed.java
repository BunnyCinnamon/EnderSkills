...
public class Bleed extends BaseAbility implements ISkillAdvancement {
    ...
    public Bleed() {
        super(LibNames.BLEED);
        setTexture(ResourceLibrary.BLEED);
    ...
    public static class Configuration {
        ...
        public static class Values {
            ...
            public String cooldown = "(5 * 20) + (5 * 20) * (1 - ((e^(-0.1 * (x / y)) - 1)/((e^-0.1) - 1)))";
            ...
            public static class Extra {
                ...
                public String dot = "4 + (((e^(0.1 * (x / y)) - 1)/((e^0.1) - 1)) * (20 - 4))";
            }
