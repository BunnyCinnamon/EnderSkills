...
public class MagicResistance extends BaseAttribute implements ISkillAdvancement {

    public MagicResistance() {
        super(LibNames.MAGIC_RESISTANCE);
        MinecraftForge.EVENT_BUS.register(this);
        setTexture(ResourceLibrary.ATTRIBUTE_0_1);
    }
    ...
    @Config(modid = LibMod.MOD_ID, name = LibMod.MOD_ID + "/Attribute/" + LibNames.MAGIC_RESISTANCE)
    public static class Configuration {

        @Config.Comment("Attribute Values")
        @Config.LangKey(LibMod.MOD_ID + ".config." + LibNames.MAGIC_RESISTANCE)
        ...
        public static class Values {
            ...
            public static class Advancement {
                ...
                public String[] upgrade = {"(0+){(170 * (1 - (0 ^ (0 ^ x)))) + ((169350000000) * (x / y))}"};
            }
        }
    }
}
