...
public class DamageResistance extends BaseAttribute implements ISkillAdvancement {
    ...
    @Config(modid = LibMod.MOD_ID, name = LibMod.MOD_ID + "/Attribute/" + LibNames.DAMAGE_RESISTANCE)
    public static class Configuration {

        @Config.Comment("Attribute Values")
        @Config.LangKey(LibMod.MOD_ID + ".config." + LibNames.DAMAGE_RESISTANCE)
        ...
        public static class Values {
            ...
            public static class Advancement {
                ...
                public String upgrade = "(136 * (1 - (0 ^ (0 ^ x)))) + ((125000000000) * (x / y))";
            }
        }
    }
}
