...
public class ExplosionResistance extends BaseAttribute implements ISkillAdvancement {
    ...
    public ExplosionResistance() {
        super(LibNames.EXPLOSION_RESISTANCE);
                ...
                if (!GuiScreen.isShiftKeyDown()) {
                    ...
                    c.get(this).ifPresent(skillInfo -> {
                        ...
                        if (attributeInfo.getLevel() < getMaxLevel()) { //Copy info and set a higher level...
                            AbilityInfo infoNew = new AbilityInfo(attributeInfo.serializeNBT());
    ...
    @Config(modid = LibMod.MOD_ID, name = LibMod.MOD_ID + "/Attribute/" + LibNames.EXPLOSION_RESISTANCE)
    public static class Configuration {

        @Config.Comment("Attribute Values")
        @Config.LangKey(LibMod.MOD_ID + ".config." + LibNames.EXPLOSION_RESISTANCE)
        ...
        public static class Values {
            ...
            public static class Advancement {
                ...
                public String[] upgrade = {"(0+){(170 * (1 - (0 ^ (0 ^ x)))) + ((125000000000) * (x / y))}"};
            }
        }
    }
}
