...
public class FallResistance extends BaseAttribute implements ISkillAdvancement {

    public FallResistance() {
        super(LibNames.FALL_RESISTANCE);
    ...
    @Config(modid = LibMod.MOD_ID, name = LibMod.MOD_ID + "/Attribute/" + LibNames.FALL_RESISTANCE)
    public static class Configuration {

        @Config.Comment("Attribute Values")
        @Config.LangKey(LibMod.MOD_ID + ".config." + LibNames.FALL_RESISTANCE)
        ...
        public static class Values {
            ...
            public String modifier = "((e^(-0.1 * (x / y)) - 1)/((e^-0.1) - 1))";
            ...
            public static class Advancement {
                ...
                public String upgrade = "(48 * (1 - (0 ^ (0 ^ x)))) + 7 * x";
            }
        }
    }
}
