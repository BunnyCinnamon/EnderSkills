...
public class HeartBoost extends BaseAttribute implements ISkillAdvancement {
    ...
    @Config(modid = LibMod.MOD_ID, name = LibMod.MOD_ID + "/Attribute/" + LibNames.HEART_BOOST)
    public static class Configuration {

        @Config.Comment("Attribute Values")
        @Config.LangKey(LibMod.MOD_ID + ".config." + LibNames.HEART_BOOST)
