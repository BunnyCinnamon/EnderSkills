...
public class FireResistance extends BaseAttribute {

    public FireResistance() {
        super(LibNames.FIRE_RESISTANCE, new Properties());
            ...
            Capabilities.get(entity).ifPresent(capability -> {
                if (capability.isOwned(this)) {
                    capability.getOwned(this).ifPresent(skillInfo -> {
                        ...
                        float resistance = 1 - DSLDefaults.getModifier(ModAttributes.FIRE_RESISTANCE, attributeInfo.getLevel());
    ...
    /*Config Section*/
    public static final String CONFIG_FILE = LibNames.ATTRIBUTE_DEFENSE_FOLDER + LibNames.FIRE_RESISTANCE;
