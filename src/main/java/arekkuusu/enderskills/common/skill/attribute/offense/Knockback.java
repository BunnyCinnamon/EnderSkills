...
public class Knockback extends BaseAttribute implements ISkillAdvancement {
    ...
    public Knockback() {
        super(LibNames.KNOCKBACK);
        MinecraftForge.EVENT_BUS.register(this);
        setTexture(ResourceLibrary.ATTRIBUTE_2_0);
    }
            ...
            if (c.owns(this)) {
                if (!GuiScreen.isShiftKeyDown()) {
                    ...
                    c.get(this).ifPresent(skillInfo -> {
                        ...
                        description.add("Strength: +" + TextHelper.format2FloatPoint(getModifier(attributeInfo) * 100));
                        if (attributeInfo.getLevel() < getMaxLevel()) { //Copy info and set a higher level...
                            ...
                            description.add("Strength: +" + TextHelper.format2FloatPoint(getModifier(infoNew) * 100));
                        }
                    });
                }
            }
    ...
    public static class Configuration {
        ...
        public static class Values {
            ...
            public static class Advancement {
                ...
                public String upgrade = "(102 * (1 - (0 ^ (0 ^ x)))) + 34 * x";
            }
        }
    }
}
