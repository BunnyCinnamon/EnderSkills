...
public class ModConfigurations {
    ...
    public static void register(IForgeRegistry<ConfigSynchronizer> registry) {
        ...
        registry.register(new StaticFieldConfigSynchronizer(AbilityRange.Configuration.class, "LOCAL_VALUES", "VALUES", LibNames.ABILITY_RANGE + "_enum"));
        registry.register(new StaticFieldConfigSynchronizer(MeleeDamage.Configuration.class, "LOCAL_VALUES", "VALUES", LibNames.DAMAGE + "_enum"));
        ...
        registry.register(new DSLConfigSynchronizer(BlackFlame.Configuration.CONFIG, LibNames.BLACK_FLAME));
        registry.register(new DSLConfigSynchronizer(BlackFlameBall.Configuration.CONFIG, LibNames.BLACK_FLAME_BALL));
        registry.register(new DSLConfigSynchronizer(BlackScouringFlame.Configuration.CONFIG, LibNames.BLACK_SCOURING_FLAME));
        registry.register(new DSLConfigSynchronizer(BlackBlessingFlame.Configuration.CONFIG, LibNames.BLACK_BLESSING_FLAME));
        registry.register(new DSLConfigSynchronizer(BlackRagingFlameBall.Configuration.CONFIG, LibNames.BLACK_RAGING_FLAME_BALL));
        registry.register(new DSLConfigSynchronizer(BlackVolleyFlame.Configuration.CONFIG, LibNames.BLACK_VOLLEY_FLAME));
        registry.register(new DSLConfigSynchronizer(BlackFlareFlame.Configuration.CONFIG, LibNames.BLACK_FLARE_FLAME));
        //
