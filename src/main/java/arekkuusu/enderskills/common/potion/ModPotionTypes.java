...
public final class ModPotionTypes {
    ...
    public static void register(IForgeRegistry<PotionType> registry) {
        ...
        registry.register(new PotionTypeBase(LibNames.ENDURANCE_EFFECT + "_normal", new PotionEffect(ModPotions.POTION_ENDURANCE_EFFECT, 0, 0)));
        registry.register(new PotionTypeBase(LibNames.ENDURANCE_EFFECT + "_strong", new PotionEffect(ModPotions.POTION_ENDURANCE_EFFECT, 0, 1)));
