...
public class EntityPlaceableBloodPool extends EntityPlaceableData {

    public static final DataParameter<ListBlockPosExtendedData> SYNC_BLOCKS_DATA = EntityDataManager.createKey(EntityPlaceableBloodPool.class, ListBlockPosExtendedData.SERIALIZER);
