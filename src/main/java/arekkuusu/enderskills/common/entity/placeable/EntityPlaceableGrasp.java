...
public class EntityPlaceableGrasp extends EntityPlaceableData {

    public static final DataParameter<ListBlockPosExtendedData> SYNC_BLOCKS_DATA = EntityDataManager.createKey(EntityPlaceableGrasp.class, ListBlockPosExtendedData.SERIALIZER);
