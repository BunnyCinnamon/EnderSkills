...
public class TeamHelper {
    ...
    public static final Predicate<Entity> HUMAN_TEAM = entity -> !ESAPI.defaultHumanTeam || !entity.isCreatureType(EnumCreatureType.MONSTER, false);
    public static final Predicate<Entity> NOT_HUMAN_TEAM = entity -> !ESAPI.defaultHumanTeam || entity.isCreatureType(EnumCreatureType.MONSTER, false);
