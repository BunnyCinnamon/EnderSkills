...
public class GleamBangSound extends MovingSound {

    public final WeakReference<EntityPlaceableData> reference;

    public GleamBangSound(EntityPlaceableData entity) {
        super(ModSounds.GLEAM_BANG_RELEASE, SoundCategory.PLAYERS);
