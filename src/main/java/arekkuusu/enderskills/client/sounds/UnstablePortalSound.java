...
public class UnstablePortalSound extends MovingSound {

    public final WeakReference<EntityPlaceableData> reference;

    public UnstablePortalSound(EntityPlaceableData entity) {
        super(ModSounds.UNSTABLE_PORTAL, SoundCategory.PLAYERS);
