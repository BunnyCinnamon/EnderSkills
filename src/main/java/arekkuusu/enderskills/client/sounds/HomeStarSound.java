...
public class HomeStarSound extends MovingSound {
    ...
    public HomeStarSound(EntityLivingBase entity) {
        super(ModSounds.HOME_STAR_ACTIVE, SoundCategory.PLAYERS);
    ...
    public void update() {
        ...
        if (entity != null && !entity.isDead) {
            if (SkillHelper.isActiveFrom(entity, ModAbilities.HOME_STAR)) {
                this.xPosF = (float) entity.posX;
                this.yPosF = (float) entity.posY;
                this.zPosF = (float) entity.posZ;
            } else {
