...
public class FlaresSound extends MovingSound {
    ...
    public FlaresSound(EntityLivingBase entity) {
        super(ModSounds.FLARES_ACTIVE, SoundCategory.PLAYERS);
    ...
    public void update() {
        ...
        if (entity != null && !entity.isDead) {
            if (SkillHelper.isActiveFrom(entity, ModAbilities.FLARES)) {
                this.xPosF = (float) entity.posX;
                this.yPosF = (float) entity.posY;
                this.zPosF = (float) entity.posZ;
            } else {
