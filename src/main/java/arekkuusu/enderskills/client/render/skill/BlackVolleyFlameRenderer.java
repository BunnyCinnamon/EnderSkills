...
import arekkuusu.enderskills.common.skill.ability.offence.blackflame.BlackVolleyFlame;
...
public class BlackVolleyFlameRenderer extends SkillRenderer<BlackVolleyFlame> {

    public BlackVolleyFlameRenderer() {
        EntityThrowableDataRenderer.add(ModAbilities.BLACK_VOLLEY_FLAME, Projectile::new);
    }
    ...
    public static class Projectile extends Render<EntityThrowableData> {
        ...
        public void doRender(EntityThrowableData entity, double x, double y, double z, float entityYaw, float partialTicks) {
            ...
            float particleScale = 0.5F + 3F * particleProgress;
