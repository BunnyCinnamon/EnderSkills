...
public class BlackScouringFlameRenderer extends SkillRenderer<BlackScouringFlame> {

    public BlackScouringFlameRenderer() {
        EntityThrowableDataRenderer.add(ModAbilities.BLACK_SCOURING_FLAME, Projectile::new);
    }
