...
public class ModelStoneGolem extends ModelBase {
    ...
    public ModelStoneGolem(float p_i1161_1_) {
        this(p_i1161_1_, -7.0F);
    }

    public ModelStoneGolem(float p_i46362_1_, float p_i46362_2_) {
        int i = 128;
        int j = 128;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        EntityStoneGolem stoneGolem = (EntityStoneGolem) entitylivingbaseIn;
        int i = stoneGolem.getAttackTimer();
